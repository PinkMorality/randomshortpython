...
class calc:
    ...
    def multiplication(x,y):
        mult = x * y
        print("%s times %s is %s." % (for_multiplication_1, for_multiplication_2, mult))

    def division(x,y):
        div = x / y
        print("%s divided by %s is %s." % (for_division_dividend, for_division_divisor, div))
